...
//   };
  return (
    <Grid container justifyContent="center" spacing={2}>
      {ProjectsDetails.map((data, index) => {
        return (
            <Grid item xs={12} sm={6} lg={5} xl={4} key={index}>
            <Card sx={{ maxWidth: "100%", height:"470px", position:"relative", color:"rgba(16, 49, 71)", background:"" }}>
            <div className="container">
              ...
              <CardActions disableSpacing sx={{position:"absolute", bottom:"0", width:"100%"}}>
                <IconButton aria-label="add to favorites">
                  <Typography sx={{fontSize:"20px"}} className="skills" variant="p">{data.skills}</Typography>
                </IconButton>
...
export default ProjectscardReact;
